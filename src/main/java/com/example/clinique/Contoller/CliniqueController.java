...
public class CliniqueController {
    ...
    private Patient updatepatient(@RequestBody Patient patient,@PathVariable Long idpatient ){
       return patientservice.updatepatient(idpatient,patient);
    }
    @DeleteMapping("/delete/{idpatient}")
    private void deletepatient(@PathVariable Long idpatient){
